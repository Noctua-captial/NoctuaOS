...
// Durable job queue backing the resumable ingest/context/extract/backtest/profile pipeline.
export const jobs = pgTable("jobs", {
  id: serial("id").primaryKey(),
  kind: text("kind").notNull(), // JobKind: ingest | context | extract | backtest | profile
